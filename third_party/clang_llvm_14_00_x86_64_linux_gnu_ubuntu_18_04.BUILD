...
cc_toolchain_import(
    name = "llvm_libunwind",
    hdrs = ["lib/clang/14.0.0/include/unwind.h"],
    includes = ["lib/clang/14.0.0/include"],
...
cc_toolchain_import(
    ...
    static_library = "lib/clang/14.0.0/lib/i386-unknown-linux-gnu/libclang_rt.builtins.a",
    target_compatible_with = select({
        "@platforms//os:linux": ["@platforms//cpu:x86_64"],
        "//conditions:default": ["@platforms//:incompatible"],
    }),
